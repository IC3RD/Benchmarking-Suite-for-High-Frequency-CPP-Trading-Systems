...
CoinbaseListener::CoinbaseListener() : Listener("wss://ws-feed.exchange.coinbase.com", "{\"type\": \"subscribe\", \"product_ids\": [\"BTC-USD\"], \"channels\": [\"ticker\"]}", "COINBASE") {}

// reference: just looking at the printing json, the dictionary's keys are very explict :)
