...
OrderManager::OrderManager() {
  ...
  orderExecutors[Exchange::BINANCE] = new BinanceOrderExecutor(dotenv::getenv
                                                               ("BINANCE_API_SECRET"),
                                                               dotenv::getenv
                                                               ("BINANCE_API_PUBLIC"));
  orderExecutors[Exchange::BITMEX] = new BitmexOrderExecutor(dotenv::getenv
                                                               ("BITMEX_API_SECRET"),
                                                               dotenv::getenv
                                                               ("BITMEX_API_PUBLIC"));
  orderExecutors[Exchange::COINBASE] = new CoinbaseOrderExecutor(dotenv::getenv
                                                               ("COINBASE_API_SECRET"),
                                                               dotenv::getenv
                                                               ("COINBASE_API_PUBLIC"));
